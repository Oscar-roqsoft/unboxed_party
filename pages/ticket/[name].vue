<template>
 ...
 line-height: 66px;" class="bigtext mx-auto px-4 text-capitalize text-grey-lighten-2 mt-6 centerIt text-center">{{event?.caption}} <br>
  ...
  <div v-if="$route.params.name.includes('Halloween')">
    ...
    <p  style="font-size: 24px;max-width:400px;" class="px-4 my-2 mx-auto font-weight-black  text-center">Select Ticket</p>
...
">
  ...
  <h1 class="text-center text-white"> 1234</h1>
    ...
    <thead>
		...
		<tr>
			<th class="text-center font-weight-black text-capitalize" style="letter-spacing:2px">PRICE</th>
			<th class="text-center font-weight-black text-capitalize" style="letter-spacing:2px">DATE</th>
			<th class="text-center font-weight-black text-capitalize" style="letter-spacing:2px">TIME</th>
    ...
    <tbody>
		...
		<tr>
			...
			<!-- <td style="font-size:14px" class="text-grey-darken-1 font-weight-bold text-center">{{1000 - sold}}</td> -->
              ...
              <v-card
                ...
                width="100%"
                class=" rounded-lg align-center pa-4"
                >
        ...
        >
          ...
          <v-btn class="mr-1" @click="copyaccount()" icon size="x-small"><v-icon icon="mdi mdi-content-copy"></v-icon></v-btn>
              ...
              margin-top: 20px; font-size:15px
          " class="text-orange-darken-1 text-left"><span style="
              font-size:18px" class="text-grey font-weight-bold">Note</span>  <br> <br> 1.  Kindly wait for your payment to be confirmed by flutterwave before closing the payment screen <br><br>  2. Final amount will include payment gateway charges <br><br>  3. Contact Support for any payment issues</p>
                            </div>
