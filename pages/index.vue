  ...
  <v-app>
    <v-card class="pa-0 ma-0" color="black" tile flat min-height="900px">
      ...
      <div style="position:relative;  z-index: 99;  min-height: 900px;" class="overflow-hidden">
        <div>
          <div v-if="$vuetify.display.mdAndUp" class="bgh">
          ...
          <div style="position: relative">
            <v-container style="z-index:99;" class="">
              <v-row style="min-height: 800px; " class="d-flex align-center py-9">
                <v-col class="d-flex align-center  mb-12" style="max-width: 700px;" :cols="cols[2]">
                  <div>
                    <!-- 😎 -->
                    <!-- 🥳 -->
                    <!-- 🎅🏾 -->
                ...
                ><v-icon class="mr-1 mt-1" icon="mdi:mdi-play-speed"></v-icon> Past Events</v-btn
                > -->
                      <v-btn variant="elevated" flat rounded color="white"
                        style="border: 2px solid #b0b0b0;overflow: hidden;" to="/shop" width="200" size="large"
                        height="55" class="text-capitalize py-0 font-weight-bold ml-3"> <v-img cover width="200"
                          height="75" eager class="mt-0"
                          src="https://res.cloudinary.com/payhospi/image/upload/c_fit,w_600/v1698217121/unboxed/Unboxed_Thelma_2_e4b9dg.jpg"></v-img>
                      </v-btn>
                    </div>
                  </div>
                ...
                <!--Reserve section  -->
                <v-col :class="$vuetify.display.smAndDown ? 'justify-center' : 'justify-end'"
                  class="d-flex  align-center  mb-12" style="max-width: 700px;" :cols="cols[2]">
                  ...
                  <iframe v-else eager class="rounded-lg" width="450" height="250" :src="fetchedVideo" frameborder="0"
            ...
            <div v-if="true" style="height: 60vh;
    position: absolute;
    width: 100%;
    bottom: 0;
    ...
    z-index: -1;"></div>
      ...
      <div :style="$vuetify.display.smAndDown ? 'margin-top: 20px;' : 'margin-top: -200px;'" style="position: relative;    
    z-index: 9; padding-top: 239px;margin-bottom: 100px;">

        <div v-if="$vuetify.display.smAndDown" class="photobanner0 d-flex justify-start">
          <v-img class="" height="" eager width="200px" v-for="n in memes" :key="n" :src="n"></v-img>
          <v-img class="" height="" eager width="200px" v-for="n in memes" :key="n" :src="n"></v-img>
        </div>
        <v-container :class="$vuetify.display.smAndDown ? 'bg-black' : ''" class="pt-0"
          style="box-shadow: 0px -42px 29px 8px #000000f0;overflow: visible; position: relative;" fluid>
          <div v-if="!$vuetify.display.smAndDown" style="    max-height: 543px;"
            class="photobanner0 d-flex align-end justify-start">
    ...
    background: linear-gradient(360deg, black, transparent);
    ;"></div>
            <v-img class="" style="    max-height: 543px;" height="100%" eager max-width="530px" width="auto"
              v-for="n in memes" :key="n" :src="n"></v-img>
            <v-img class="" style="    max-height: 543px;" height="100%" eager max-width="530px" width="auto"
              v-for="n in memes" :key="n" :src="n"></v-img>
          </div>
          <!-- <v-card image="https://res.cloudinary.com/payhospi/image/upload/c_fit,w_600/v1700458125/Unboxed_Party_Meme_Party_2_usm8ub.jpg" style="opacity: 0.05;position: absolute;top: 0;z-index: -1; left: 0;height: 100%;width: 100%;" ></v-card> -->
          <v-container class="py-0">
            <v-row style="z-index: 999999;position: relative;" class="d-flex align-center pt-0">
              <!-- <div v-if="true" style="height: 60vh;
    position: absolute;
    width: 100%;
    background: linear-gradient(360deg, black, transparent);
    ...
    z-index: 99;" class="mb-0 d-flex  justify-center" :cols="cols[2]">
      ...
      z-index: 9;height: 200px;" class=" mt-8">
            ...
            <div style="margin-top: 20px;" class="photobanner1 h-100 d-flex justify-start">
              <v-img class="mdpert" height="100" eager width="180" v-for="n in media_parteners" :key="n"
                :src="n"></v-img>
              <v-img class="mdpert" height="100" eager width="180" v-for="n in media_parteners" :key="n"
                :src="n"></v-img>
      ...
      <!-- <v-container>
 <v-row class="d-flex align-center pt-9">
   <v-col :class="$vuetify.display.mdAndDown ?'order-2':'order-1'" class="mb-6" :cols="cols[2]">
     <h1 style="  font-weight: 700;
  font-size: 50px;
  line-height: 60px;" class="text--white bigtext centerIt text-left">Countdown<br>
    <vue-countdown style="  font-weight: 700;
  font-size:40px;" class="text-white-darken-1" :time="timediff2" v-slot="{ days, hours, minutes, seconds }">
   {{ days }}:{{ hours }}:{{ minutes }}:{{ seconds }}
  </vue-countdown>
</h1>
  
     <div class="py-3 centerIt text-left my-4">
       <v-btn
      ...
      <v-col :class="$vuetify.display.mdAndDown ?'order-1':'order-2'" :cols="cols[2]">
     <v-img 
       class="rounded-lg"
       width="100%" eager
       height="auto"
     ...
     ></v-img>
      ...
      <v-container style="min-height: " :class="$vuetify.display.smAndDown ? 'mt-0' : 'pt-12 mt-12'">
        ...
        <v-row class="py-9">
          <v-col cols="12" lg="8">
            <v-card to="/shop" color="transparent" flat height="100%" max-height="500">

              <v-img @click="$router.push('/shop')" style="cursor: pointer;" class="rounded-lg" eager max-height="500"
                height="100%" cover
                src="https://res.cloudinary.com/payhospi/image/upload/c_fit,w_1000/v1698217121/unboxed/Unboxed_Thelma_2_e4b9dg.jpg"></v-img>
            </v-card>
          </v-col>
          <v-col cols="12" lg="4">
            <v-row>
              <v-col v-for="(item, i) in items.slice(0, 4)" :key="item.id" cols="6">
                <v-card :to="'/shop/' + item.name" color="transparent" flat height="">
                  ...
                  <h3 style="font-size: 20px;" class="font-weight-medium mt-2 text-capitalize text-truncate text-white">
                    {{ item.name }}</h3>
      ...
      <div class="d-flex align-center justify-center" style="min-height: 800px;">

        <v-container style="position: relative " class="mt-12">
          <v-img eager class="rotimg" width="400px" style="position: absolute; left: -200px; top: calc(50% - 150px)"
            src="https://res.cloudinary.com/crushcontest-com/image/upload/v1679658507/Vector_5_1_hx2cls.png"></v-img>
          <v-img eager class="rotimg" width="400px" style="position: absolute; right: -200px; top: calc(50% - 150px)"
            src="https://res.cloudinary.com/crushcontest-com/image/upload/v1679658409/Ellipse_4_1_babxrn.png"></v-img>

          <div class="d-flex align-center" style="max-width: 560px">
            <p class="text-caption mr-2 text-grey-lighten-2 font-weight-light">
              @the_unboxedparty
            </p>
            <v-divider style="border-width: 1px"></v-divider>
          </div>
          <v-row class="d-flex py-9">
            <v-col :cols="cols[2]">
              <h1 class="herotitle2">
                Unleash the Fun with Unboxed Party
              </h1>
            </v-col>
            <v-col :class="$vuetify.display.smAndDown ? 'pt-0' : 'pt-4'" class=" centerIt" :cols="cols[2]">
              <p :class="$vuetify.display.smAndDown ? 'mb-4' : ''" class="text-grey-lighten-1 px-2 py-4">
                Unboxed Party is your go-to destination for unique and exciting events in the Nigeria (for now sha 😉).
                From Arabian Fest to Halloween, Meme Party to Royal Ball/Prom, we bring you the best in themed
                entertainment. Since our inception, we have been growing rapidly, with each event exceeding expectations
                and setting new standards. Our monthly events are the talk of the town, and we pride ourselves on
                delivering unforgettable experiences that keep people coming back for more. Join us and unleash the fun
                at Unboxed Parties!
              </p>
              <v-btn size="large" rounded to="/ticket/list" variant="outlined" style="border: 2px solid #ffffff"
                class="text-capitalize mt-4">See Upcoming Events</v-btn>
            </v-col>
          </v-row>
        </v-container>
      </div>
      <v-container :class="$vuetify.display.smAndDown ? 'mt-0' : 'mt-12'">
        <div class="centerIt" style="position:relative">
          <h1 class="herotitle  mb-4 text-center">Past Events</h1>
          <div class=" px-2 justify-space-between align-center">
            <p class=" text-grey-lighten-1 text-center font-weight-light">
              The coolest parties around you.
            </p>
        ...
        <v-row class="d-flex pt-9">
          <v-col v-show="!parseFloat(n.on_sale)" v-for="(n, i) in events.slice(0, 5)" :key="i" :cols="cols[3]">
            <div class="pt-6 d-flex justify-center">
              ...
              <v-card v-else width="100%" max-width="500px" :to="'/event/' + encodeURIComponent(n.name)"
                color="transparent" class="pa-3">
                <v-img eager cover height="350px" max-width="500px" class="rounded-xl"
                  :src="imageFilter(n.image, 700)"></v-img>
        ...
        <div class="py-12 d-flex justify-center">
          <v-btn to="/events" size="x-large" class="mx-auto text-capitalize font-weight-bold " rounded color="white">See
            more</v-btn>
        </div>
      ...
      <v-container style="position: relative" class="">
        ...
        <v-row class="d-flex justify-center py-9">
          <v-col class="d-flex justify-center" cols="12">
            <v-card max-width="650px" flat tile color="transparent" style="overflow: visible; display:flex"
              class="justify-space-between">
              <v-row class="d-flex pa-8">
                <v-col class="godown pics8 d-flex align-center justify-center" cols="4">
                  <v-img eager
                    src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680238980/Person_Chris_Skin_Tone_Black_Posture_17_Happy_Winking_jzw2vo.png"></v-img>
                </v-col>
                <v-col class="d-flex pics1 align-center justify-center" cols="4">

                  <v-img eager style="
    scale: 1.6;
" src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680238981/Person_Ed_Skin_Tone_Black_Posture_1_Happy_dfeklq.png"></v-img>
                </v-col>
                <v-col class="godown pics2 d-flex align-center justify-center" cols="4">

                  <v-img eager
                    src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680238979/Character_Mary_Skin_tone_White_Posture_27_Sh_e68nio.png"></v-img>
                </v-col>
                <v-col class="d-flex pics7 align-center justify-center" cols="3">

                  <v-img eager @load="animImg()" style="
    scale: 1.5;
" src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680238977/Character_Darlene_Skin_tone_White_Posture_9_Lovely_bkhiqo.png"></v-img>
                </v-col>

                <v-col class="py-4 justify-center d-flex centerIt" cols="6">
                  <h1 class="herotitle2 text-center">
                    Created by Ravers.
                  </h1>

                </v-col>
                <v-col class="d-flex pics3 align-center justify-center" cols="3">

                  <v-img eager style="
    scale: 1.5;
" src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680238977/Character_Angela_Skin_tone_Black_Posture_8_Star_Eye_c7g0od.png"></v-img>
                </v-col>
                <v-col class=" pics6 goup d-flex align-center justify-center" cols="4">

                  <v-img eager style="
    scale: 1;
" src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680247343/28_29_gfibxr.png"></v-img>
                </v-col>
                <v-col style="z-index: 999;" class="pics5 d-flex align-center justify-center" cols="4 ">

                  <v-img eager style="
    scale: 1.5;
" src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680248707/Character_Ishanvi_Skin_tone_Black_Posture_26_Crossing_Finger_hdukf3.png"></v-img>
                </v-col>
                <v-col class="pics4 goup d-flex align-center justify-center" cols="4">

                  <v-img eager style="
    scale: 1;
" src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680238979/Character_Mary_Skin_tone_Black_Posture_1_Happy_ephuz0.png"></v-img>
                </v-col>
              </v-row>
              <!-- <v-img eager class="pics"  src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680238980/Person_Chris_Skin_Tone_Black_Posture_17_Happy_Winking_jzw2vo.png"></v-img>
</v-col>
          <v-col class="d-flex align-center justify-center" 
 cols="4">

<v-img eager class="pics" style="
    
" src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680238981/Person_Ed_Skin_Tone_Black_Posture_1_Happy_dfeklq.png"></v-img>
</v-col>
          <v-col class="godown d-flex align-center justify-center" 
 cols="4">

<v-img eager class="pics"  src="https://res.cloudinary.com/crushcontest-com/image/upload/v1680238979/Character_Mary_Skin_tone_White_Posture_27_Sh_e68nio.png"></v-img>
</v-col>
          <v-col class="d-flex align-center justify-center" 
 cols="3">
...
<v-col class=" goup d-flex align-center justify-center" 
 cols="4">
      ...
      <div class="d-flex align-center justify-center" style="min-height: 800px;">
        ...
        <v-container :class="$vuetify.display.smAndDown ? 'mt-0' : 'mt-12'">
          <div class="centerIt" style="position:relative">
            ...
            <h1 class="herotitle mb-4 text-center">Quick Reads</h1>
          ...
          <v-row class="d-flex pt-9">
            <v-col v-for="n in articles.slice(0, 2)" :key="n.name" class="pt-3 pb-3" :cols="cols[2]">
              ...
              <v-card v-else max-width="650px" :height="$vuetify.display.mdAndDown ? 'auto' : '540px'"
                :to="'/article/' + encodeURIComponent(n.name)" class="rounded-xl mx-auto  pa-3">
                <v-img cover eager height="auto" max-height="400px" width="100%" max-width="650px" class="rounded-xl"
                  :src="n.image"></v-img>
                <h2 style="font-size: 40px " class="text-truncate font-weight-bold text-grey-lighten-2 logoText pt-1">
                  {{ n.name }}
                </h2>

                <p class="text-body-2 mt-2  text-grey-lighten-1 font-weight-medium">
          ...
          <div class="py-12 d-flex justify-center">
            <v-btn to="/articles" size="x-large" class="mx-auto text-capitalize font-weight-bold " rounded
              color="white">See more</v-btn>
          </div>
...
export default {
  ...
  data: () => ( {
    ...
    media_parteners: [
      ...
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484759/All%20unbox%20images/i9mzpjaerpip10jrk8x1.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484759/All%20unbox%20images/g7rjmavkiznwr0yvhst4.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484756/All%20unbox%20images/pes8qxgrxf1eszsigwkk.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484756/All%20unbox%20images/l16bvzfdxkevaqf9lwup.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484753/All%20unbox%20images/qtmussgguyhj6xnfczrj.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484753/All%20unbox%20images/fojhjmjogvxyv6x6dths.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484752/All%20unbox%20images/nxzp7wepmhsp0q7ndbjx.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484752/All%20unbox%20images/b2v0dlwztacvmdlvhdnt.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484749/All%20unbox%20images/emvluxfkwcnidjzbek1i.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484748/All%20unbox%20images/hsjn2q2qxkcqnhbf0ht1.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484743/All%20unbox%20images/rfup3rvtogakj2dsg3rw.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484743/All%20unbox%20images/dqxp5xvoffeqz0hlstd0.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484735/All%20unbox%20images/ut4e1aqiz1ivfjzmnfdz.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484732/All%20unbox%20images/ymx94slgvgvbrvveuu1r.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484731/All%20unbox%20images/c6ndxoylezlg8lzi4sgb.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484730/All%20unbox%20images/gohgkjebgw6m60zwyetd.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484727/All%20unbox%20images/omjb9t9v173taj7pzgvh.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484726/All%20unbox%20images/cejmhndgakcxl9ilispg.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484723/All%20unbox%20images/dw0kboz6sqbz9ufzkvhi.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484721/All%20unbox%20images/rx1jhtunlzgoilh6so7i.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484712/All%20unbox%20images/fv4rdmdadbt0fhzpaent.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484711/All%20unbox%20images/qc7dpo3x5ho5o3sagep4.png',
      'https://res.cloudinary.com/dvexjmvti/image/upload/v1737484708/All%20unbox%20images/gwgpekpnng2swv3jxc1d.png'
    ],
    sponsors: [
  ...
  methods: {
    ...
    animImg2() {
      // alert(9)
      const img1 = document.querySelector( '.pics1' );
      const img2 = document.querySelector( '.pics2' );
      const img3 = document.querySelector( '.pics3' );
      const img4 = document.querySelector( '.pics4' );
      const img5 = document.querySelector( '.pics5' );
      const img6 = document.querySelector( '.pics6' );
      const img7 = document.querySelector( '.pics7' );
      const img8 = document.querySelector( '.pics8' );
      var imgslist = [img1, img2, img3, img4, img5, img6, img7, img8];
      gsap.to( imgslist,
        {
          scale: 1.2,
          rotate: '4deg',
...
.shadow img.v-img__img.v-img__img--contain {
