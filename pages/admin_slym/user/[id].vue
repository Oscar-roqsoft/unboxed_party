...
Actions 
           ...
           <p
             ...
             >
              ...
              <v-btn
               color="purple-darken-4" :loading="loading2" 
               @click="sendTicketBtn(user)"
                 size="small">
...
<v-row class="pa-5" v-if="user.tickets">
    ...
    <v-col v-for="(item,i) in tickets" :key="i" class="d-flex align-center justify-center" md="4" sm="6" xs="12" lg="3">

      <v-card 
            max-width=""
            color=""
            width="320" style="position:relative"
            height="auto"
    ...
    <div class="">
      ...
      <h1 style="
        ...
        :href="
                    ...
                    target="_blank"
        size="small"  color="green-darken-3" block> send <v-icon icon="mdi mdi-whatsapp"></v-icon></v-btn>
    </div>
                    </v-card>
                    </v-col>
  </v-row>
