<template>
  ...
  <v-container :class="$vuetify.display.smAndDown?'px-0':''" class="py-12 px-6" style="overflow:hidden">
        ...
        <v-row class="flex-wrap d-flex" wrap >
            ...
            <v-col class="pa-1 d-flex align-center justify-center"  :cols="cols[5]">
              <v-img eager  height="184" max-width="320" width="100%" src="https://res.cloudinary.com/dpehz96bs/image/upload/c_fit,w_500,h_500/v1710232447/Artboard11_ea2gi4.png"></v-img>
            </v-col>
            <v-col class="pa-1 d-flex align-center justify-center"  :cols="cols[5]">
  ...
  <div id="contact">
    ...
    <v-container style="position: relative" class="my-12 pa-6">
      <v-img
      width="300px"
        style="position: absolute; left: -120px; top: calc(50% - 150px)"
        src="https://res.cloudinary.com/crushcontest-com/image/upload/v1679725847/Group_5_bunz8h.png"
      ></v-img>
      <v-img
      width="300px"
        style="position: absolute; right: -120px; top: calc(50% - 150px)"
        src="https://res.cloudinary.com/crushcontest-com/image/upload/v1679725850/Group_6_rrvh5z.png"
      ></v-img>
      <v-card style="" :class="$vuetify.display.smAndDown ? 'pt-8 pb-4' :'pt-12 pb-8'" class="text-center cardStylea  pa-5">
        <h1
          style="
        ...
        <v-btn
          class="font-weight-bold text-capitalize mb-6 mt-8 text-white"
          size="x-large"
          rounded target="_blank" href="https://wa.me/+2349012770000?text= Hi%20"
          outline
          style="
    ...
    <v-container class="centerIt py-8">
      <v-row>
        <v-col class="text-center" :cols="cols[5]">
          ...
          <v-img eager class="mx-auto" height="auto" contain @click="$router.push('/')" width="auto" max-width="200" src="https://res.cloudinary.com/crushcontest-com/image/upload/v1684055372/Unboxed_Web_rggvdz.png"></v-img>
...
The box is limitless.          </p>
          ...
          <div class="py-12">
            ...
            /></v-btn>
              ...
              <v-btn icon class="mr-4" variant="outlined"
        ...
        <v-col :cols="cols[4]">
          <v-row class="d-flex justify-end">
            ...
            >
              ...
              <a
                v-for="(n, i) in n.links"
                :key="i"
                :href="n.link"
                class="text-right centerIt text-decoration-none"
              >
                <p
                  class="py-2  text-grey"
      ...
      <v-img @click="$router.push('/shop')" eager style="cursor: pointer;" class="rounded-lg mt-12" height="auto" cover src="https://res.cloudinary.com/payhospi/image/upload/c_fit,w_1000/v1698217127/unboxed/Unboxed_Thelma_1_qnjvmo.jpg"></v-img>
